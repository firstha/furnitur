...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<link href="{{ asset('furni/https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css') }}" rel="stylesheet">
		<link href="{{ asset('furni/css/tiny-slider.css') }}" rel="stylesheet">
		<link href="{{ asset('furni/css/style.css') }}" rel="stylesheet">
		<title>Website Furnitur</title>
	</head>
	...
	<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					...
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						...
						<li><a class="nav-link" href="#"><img src="{{ asset('furni/images/cart.svg') }}"></a></li>
					</ul>
				</div>
			</div>
		...
		<footer class="footer-section">
			<div class="container relative">
				...
				<div class="sofa-img">
					<img src="{{ asset('furni/images/sofa.png') }}" alt="Image" class="img-fluid">
				</div>
				...
				<div class="border-top copyright">
					<div class="row pt-4">
						<div class="col-lg-6">
							<p class="mb-2 text-center text-lg-start">Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; By Admin  <!-- License information: https://untree.co/license/ -->
            </p>
						</div>
